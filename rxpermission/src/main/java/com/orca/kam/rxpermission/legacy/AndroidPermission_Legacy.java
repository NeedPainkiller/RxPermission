...
import com.orca.kam.rxpermission.legacy.fragment.PermissionFragment_Legacy;
 ...
 */
public class AndroidPermission_Legacy {


    private static boolean isAvailableInflate = false;
    private static PermissionListener_Legacy listener;
    private Context context;
    private final PermissionContent_Legacy content = new PermissionContent_Legacy();

    private final List<String> permissions = new ArrayList<>();


    /**
     * Constructor. Prepares a new AndroidPermission_Legacy Setting up
     *
     * @param context(Activity or Application) Get String Resource, Package name, start Permission Activity and check Permissions
     */
    public AndroidPermission_Legacy(Context context) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setExplanationMessage(String message) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setExplanationMessage(@StringRes int messageId) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setExplanationConfirmButtonText(String buttonText) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setExplanationConfirmButtonText(@StringRes int buttonTextId) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setDeniedMessage(String deniedMessage) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setDeniedMessage(@StringRes int deniedMessageResID) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setDeniedCloseButtonText(String deniedCloseButtonText) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setDeniedCloseButtonText(@StringRes int deniedCloseButtonTextResID) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setShowSettingButtonText(String showSettingButtonText) {
     ...
     * @return Method chaining, AndroidPermission_Legacy.
     */
    public AndroidPermission_Legacy setShowSettingButtonText(@StringRes int showSettingButtonTextResID) {
    ...
    public AndroidPermission_Legacy request(String permission) {
        this.permissions.add(permission);
        return this;
    }


    public AndroidPermission_Legacy request(String... permissions) {
        return request(Lists.newArrayList(permissions));
    }


    public AndroidPermission_Legacy request(List<String> permissions) {
                ...
                Observable.create((ObservableOnSubscribe<List<String>>) subscriber -> {
                    if (isEmpty(permissions)) {
                        ...
                        if (isAllPermissionGranted()) {
                            ...
                            listener = new PermissionListener_Legacy() {
...
//        observable.mergeWith(activity());
    ...
    @DebugLog private void startPermissionActivity() {
        Intent intent = Henson.with(context)
                .gotoPermissionActivity_Legacy().content(content).build();
        context.startActivity(intent);
    }


    @DebugLog private void startPermissionFragment(Activity activity) {
        PermissionFragment_Legacy permissionFragment = findPermissionFragment(activity);
        if (permissionFragment == null) {
            permissionFragment = new PermissionFragment_Legacy();
        }
    ...
    @DebugLog
    private PermissionFragment_Legacy findPermissionFragment(Activity activity) {
        return (PermissionFragment_Legacy) activity.getFragmentManager().findFragmentByTag(TAG_FRAGMENT);
    }
